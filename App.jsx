  ...
  const translateText = async (text) => {
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      headers: {
        ...
        Authorization: `Bearer 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`,
      },
      body: JSON.stringify({
        model: "gpt-3.5-turbo",
